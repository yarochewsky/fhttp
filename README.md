...
**NOTE**
This maintenance of this library has moved over to [yarochewsky](https://github.com/yarochewsky/fhttp). The only use for this repository is so imports will not break.
